...
- JSON: `docs/research/2026-04-27-sunken-ship-p0-latest-manual-confirmation-ingest-report.json`
- Source: `<local-downloads>/2026-04-27-sunken-ship-p0-manual-count-confirmation-results (1).json`
- Status: `no_accepted_samples`
- Accepted samples: `0`
- Blocked entries: `2`
- Manual candidate replay passed: `false`
- Authority sample import ready: `false`
- Default weight update allowed: `false`
- Next action: `collect_human_confirmed_count_fit_samples`
