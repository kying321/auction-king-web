# P1 Manual Confirmation Intake Refresh

- JSON: `docs/research/2026-04-27-sunken-ship-p1-manual-confirmation-intake-refresh.json`
...
## Commands
- rerun intake: `npm run intake:p1-manual-confirmation`
