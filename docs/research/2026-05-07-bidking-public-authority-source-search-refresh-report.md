...
- JSON: `docs/research/2026-05-07-bidking-public-authority-source-search-refresh-report.json`
- Target item id: `1106013`
- Direct public authority row found: `false`
- Current full-client depot: `4128581`
- Current full-client table files visible: `true`
- Current full-client Item.txt size: `487.41 KiB`
- SteamDB visible manifest count: `25`
- Visible Item.txt change count: `0`
- Current full-client path viable: `true`
...
| --- | --- | --- | --- |
| `steam_current_full_client_selective_tables_download` | `source_candidate_requires_table_download_and_scan` | `high` | `if_row_found` |
