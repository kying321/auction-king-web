...
test("front page uses Chinese task header and decision-first shell", () => {
    ...
    assert.match(html, /result_panel_runtime\.js\?v=/);
    assert.match(html, /sample_dataset\.js\?v=/);
    assert.match(html, /source_data_runtime\.js\?v=/);
    assert.match(html, /authority_calibration_runtime\.js\?v=/);
    assert.match(html, /numeric_input_runtime\.js\?v=/);
    assert.match(html, /config_editor_runtime\.js\?v=/);
    assert.match(html, /field_panel_runtime\.js\?v=/);
    assert.match(packageJson.scripts["build:static"], /result_panel_runtime\.js/);
    assert.match(packageJson.scripts["build:static"], /sample_dataset\.js/);
    assert.match(packageJson.scripts["build:static"], /source_data_runtime\.js/);
    assert.match(packageJson.scripts["build:static"], /authority_calibration_runtime\.js/);
    assert.match(packageJson.scripts["build:static"], /numeric_input_runtime\.js/);
    assert.match(packageJson.scripts["build:static"], /config_editor_runtime\.js/);
    assert.match(packageJson.scripts["build:static"], /field_panel_runtime\.js/);
    ...
    assert.match(packageJson.scripts["check:js"], /result_panel_runtime\.js/);
    assert.match(packageJson.scripts["check:js"], /sample_dataset\.js/);
    assert.match(packageJson.scripts["check:js"], /source_data_runtime\.js/);
    assert.match(packageJson.scripts["check:js"], /numeric_input_runtime\.js/);
    assert.match(packageJson.scripts["check:js"], /config_editor_runtime\.js/);
    assert.match(packageJson.scripts["check:js"], /field_panel_runtime\.js/);
